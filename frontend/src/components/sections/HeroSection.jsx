        ...
        <div className="max-w-4xl mx-auto">
            ...
            <AnimateOnScroll stagger={200}>
                <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
                    <button className="bg-white text-black font-semibold px-8 py-3 rounded-md w-full sm:w-auto hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-gray-500/10">Start Debating For Free</button>
                    <button className="border border-gray-700 text-gray-300 font-semibold px-8 py-3 rounded-md w-full sm:w-auto hover:bg-gray-900 hover:border-gray-500 transition-all duration-300 transform hover:scale-105">How it Works</button>
                </div>
            </AnimateOnScroll>
        </div>
    </section>
