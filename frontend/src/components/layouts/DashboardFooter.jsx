 ...
 const DashboardFooter = () => {
   const linkedinUrl = "https://www.linkedin.com/in/mahir-abidi/";
   const twitterUrl = "https://x.com/abidi_mahir";
   const githubUrl = "https://github.com/mahirabidi12";
         ...
         <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
           ...
           <div>
             ...
             <ul className="space-y-3 mt-4">
               <li>
                 <Link
                   to="/#features" // Assuming Features section is on LandingPage
               ...
               <li>
                 <Link
                   to="/#pricing" // Assuming Pricing section is on LandingPage
                   className="hover:text-white transition-colors"
                 >
                   Pricing
                 </Link>
           ...
           <div>
             ...
             <ul className="space-y-3 mt-4">
               ...
               <li>
                 <Link
                   to="/#community" // Assuming Community section is on LandingPage
                   className="hover:text-white transition-colors"
                 >
                   Community
                 </Link>
