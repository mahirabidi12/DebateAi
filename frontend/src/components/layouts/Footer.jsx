                 ...
                 <div className="relative text-center rounded-t-3xl py-16 px-8 overflow-hidden">
                    <canvas ref={canvasRef} className="absolute top-0 left-0 w-full h-full z-0" />
                     <div className="relative z-10">
                         ...
                         <Link to="/signup" className="mt-8 inline-block bg-indigo-500 text-white font-semibold px-8 py-3 rounded-md hover:bg-indigo-600 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-indigo-500/20">Start For Free</Link>
                     </div>
                 </div>
            </div>
